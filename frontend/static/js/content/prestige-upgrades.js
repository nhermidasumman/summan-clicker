...
export const calculateInnovationPoints = Prestige.calculateInnovationPoints;
export const getBaseMultiplier = Prestige.getBaseMultiplier;
export const dataForNextPoint = Prestige.dataForNextPoint;
export const getUpgrades = Prestige.getUpgrades;
export const getUpgradeById = Prestige.getUpgradeById;
export const getName = Prestige.getName;
export const getDesc = Prestige.getDesc;
export const getAvailable = Prestige.getAvailable;
export const getAggregatedEffects = Prestige.getAggregatedEffects;
