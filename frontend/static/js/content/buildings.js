...
const Buildings = (() => {
    ...
    function getCost(buildingId, owned) {
        ...
        return calculateBuildingCost(def.baseCost, owned, def.growthRate);
    }
...
export const getAll = Buildings.getAll;
export const getById = Buildings.getById;
export const getCost = Buildings.getCost;
export const getDps = Buildings.getDps;
export const getVisible = Buildings.getVisible;
