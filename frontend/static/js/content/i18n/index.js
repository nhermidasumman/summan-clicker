...
const Lang = (() => {
    ...
    const translations = {
        es: {
            ...
            tutorial_dps_expl: 'Gracias al capitalismo, ahora produces valor automáticamente.',
        ...
        en: {
            ...
            tutorial_dps_expl: 'Thanks to capitalism, you now produce value automatically.',
...
export const setLanguage = Lang.setLanguage;
export const getLanguage = Lang.getLanguage;
export const getAvailableLanguages = Lang.getAvailableLanguages;
export default Lang;
