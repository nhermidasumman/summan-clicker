...
const Utils = (() => {
    ...
    function calculateBuildingCost(baseCost, owned, growthRate = 1.15) {
        return nextBuildingCost(baseCost, owned, growthRate);
    }
    ...
    function calculateBulkCost(baseCost, owned, count, growthRate = 1.15) {
        return bulkBuildingCost(baseCost, owned, count, growthRate);
    }
    ...
    function maxAffordable(baseCost, owned, budget, growthRate = 1.15) {
        return maxAffordableBuildingCount(baseCost, owned, budget, growthRate);
    }
...
export const formatDps = Utils.formatDps;
export const formatTime = Utils.formatTime;
export const formatDate = Utils.formatDate;
export const calculateBuildingCost = Utils.calculateBuildingCost;
export const calculateBulkCost = Utils.calculateBulkCost;
export const maxAffordable = Utils.maxAffordable;
export const randomRange = Utils.randomRange;
export const randomInt = Utils.randomInt;
export const debounce = Utils.debounce;
export const createParticle = Utils.createParticle;
export const pulse = Utils.pulse;
